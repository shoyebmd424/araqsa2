...
import { homeform } from "../component/Schemas";
...
function Book() {
  ...
  return (
    <div className=" bg-secondary m-auto  col-md-3 mt-3 p-4 offset-md-2 rounded ">
      <h3 className="text-center text-white">Book Your Demo Class</h3>
